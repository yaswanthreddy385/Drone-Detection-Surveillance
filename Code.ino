...
String SOS_NUM = "+916304621255"; // Add a number on which you want to receive call or SMS
...
void setup()
{
  ...
  Serial1.println("AT+CGMM");               // Just Checking
  delay(1000);

  Serial1.println("ATI");               // Just Checking
  delay(1000);

  Serial1.println("AT+CPIN?");               // Just Checking
  delay(1000);
  
  Serial1.println("AT+COPS=?");               // Just Checking
  delay(1000);

  Serial1.println("AT+CMGF=1");               // Just Checking
  delay(1000);

  Serial1.println("AT+CSMP = 17,167,0,0");               // Just Checking
  delay(1000);

  Serial1.println("AT+CPMS= \"SM\",\"ME\",\"SM\" ");               // Just Checking
  delay(1000);
